...
class Parameters extends React.Component {
  ...
  render = () => (
    <List>
      ...
      <ListItem>
        <ZusSizeToggle
          callbackChange={this.setZusSmallSize}
          value={this.state.zusSmallSize}/>
        <ZusHealthToggle
          callbackChange={this.setZusHealth}
          value={this.state.zusHealth}/>
      </ListItem>
      <ListItem>
        <TaxChoice
          callbackChange={this.setTaxChoice}
          value={this.state.taxChoice}/>
      </ListItem>
    </List>
  );
}
